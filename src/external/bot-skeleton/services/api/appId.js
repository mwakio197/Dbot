...
export const generateDerivApiInstance = () => {
    ...
    // Use 'deriv' as fallback brand name
    const brand = website_name?.toLowerCase() === 'binaryfx' ? 'deriv' : website_name.toLowerCase();
    const socket_url = `wss://${cleanedServer}/websockets/v3?app_id=${cleanedAppId}&l=${getInitialLanguage()}&brand=${brand}`;
